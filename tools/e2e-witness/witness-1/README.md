...
| [`b265acfc66`](https://github.com/ARAS-Workspace/phantom-browser-core/commit/b265acfc66) | no profile is eligible for glic and no profile builds its service | a keyed service that is never constructed is invisible to a page, and the two glic pages that read the same answer are chrome pages a harness page cannot open |
